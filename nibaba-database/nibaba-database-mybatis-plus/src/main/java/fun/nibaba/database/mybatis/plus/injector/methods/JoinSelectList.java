package fun.nibaba.database.mybatis.plus.injector.methods;

import com.baomidou.mybatisplus.core.injector.AbstractMethod;
import com.baomidou.mybatisplus.core.metadata.TableInfo;
import com.baomidou.mybatisplus.core.toolkit.sql.SqlScriptUtils;
import fun.nibaba.database.mybatis.plus.enums.NibabaSqlMethod;
...
public class JoinSelectList extends AbstractMethod {
    ...
    private final static String LAST_SQL_SEGMENT = WRAPPER_DOT + "lastSqlSegment";
    ...
    protected String last() {
        return SqlScriptUtils.convertIf(SqlScriptUtils.unSafeParam(LAST_SQL_SEGMENT),
                String.format("%s != null and %s != null", WRAPPER, LAST_SQL_SEGMENT),
                true);
    }
