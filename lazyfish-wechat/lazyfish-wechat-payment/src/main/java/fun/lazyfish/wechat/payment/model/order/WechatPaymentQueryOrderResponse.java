package fun.lazyfish.wechat.payment.model.order;

import cn.hutool.core.util.StrUtil;
import com.thoughtworks.xstream.annotations.XStreamAlias;
import fun.lazyfish.wechat.payment.enums.ResultCode;
import fun.lazyfish.wechat.payment.model.WechatPaymentResponse;
import fun.lazyfish.wechat.payment.utils.LocalDateTimeUtil;
import lombok.Data;
...
public class WechatPaymentQueryOrderResponse extends WechatPaymentResponse {
    ...
    /**
     * 交易状态 {@link fun.lazyfish.wechat.payment.enums.TradeState}
     * SUCCESS--支付成功
     * REFUND--转入退款
     * NOTPAY--未支付
     * CLOSED--已关闭
    ...
    /**
     * 付款银行 {@link fun.lazyfish.wechat.payment.enums.BankType}
     */
