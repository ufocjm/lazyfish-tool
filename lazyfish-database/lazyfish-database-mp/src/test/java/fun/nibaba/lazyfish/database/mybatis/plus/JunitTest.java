package fun.nibaba.lazyfish.database.mybatis.plus;

import fun.nibaba.lazyfish.database.mybatis.plus.entity.User;
import fun.nibaba.lazyfish.database.mybatis.plus.mapper.UserMapper;
import fun.nibaba.lazyfish.database.mybatis.plus.service.UserService;
import fun.nibaba.lazyfish.database.mybatis.plus.wrappers.LazyWrappers;
