...
public interface LazyMapper<Entity> extends BaseMapper<Entity> {
     ...
     * @return 数据
     */
    List<Map<String, Object>> joinSelectList(@Param(Constants.WRAPPER) AbstractLazyWrapper<Entity, ?> wrapper);
     ...
     * @return 数据
     */
    default <EntityClass> List<EntityClass> joinSelectList(@Param(Constants.WRAPPER) AbstractLazyWrapper<Entity, ?> wrapper, Class<EntityClass> entityClass) {
     ...
     * @return 数据
     */
    Map<String, Object> joinSelect(@Param(Constants.WRAPPER) AbstractLazyWrapper<?, ?> wrapper);
     ...
     * @return 数据
     */
    default <EntityClass> EntityClass joinSelect(@Param(Constants.WRAPPER) AbstractLazyWrapper<?, ?> wrapper, Class<EntityClass> entityClass) {
     ...
     * @return 数据
     */
    <EntityClass, PageEntity extends IPage<EntityClass>> IPage<Map<String, Object>> joinSelectPage(PageEntity page, @Param(Constants.WRAPPER) AbstractLazyWrapper<Entity, ?> wrapper);
     ...
     * @return 数据
     */
    default <EntityClass, PageEntity extends IPage<EntityClass>> PageEntity joinSelectPage(PageEntity page, @Param(Constants.WRAPPER) AbstractLazyWrapper<Entity, ?> wrapper, Class<EntityClass> entityClass) {
