package fun.nibaba.lazyfish.database.mybatis.plus.components;

import com.baomidou.mybatisplus.core.handlers.MetaObjectHandler;
import fun.nibaba.lazyfish.database.mybatis.plus.model.FillInsertModel;
import fun.nibaba.lazyfish.database.mybatis.plus.model.FillUpdateModel;
 ...
 */
@AllArgsConstructor
public class LazyMybatisPlusMetaObjectHandler implements MetaObjectHandler {
