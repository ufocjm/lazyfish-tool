package fun.nibaba.lazyfish.database.mybatis.plus.conf;
...
import fun.nibaba.lazyfish.database.mybatis.plus.components.DefaultFillUserSupport;
import fun.nibaba.lazyfish.database.mybatis.plus.components.FillUserSupport;
import fun.nibaba.lazyfish.database.mybatis.plus.components.LazyMybatisPlusMetaObjectHandler;
import fun.nibaba.lazyfish.database.mybatis.plus.injector.LazySqlInjector;
...
public class InitConfiguration {
    ...
    public MetaObjectHandler nibabaMybatisPlusMetaObjectHandler(FillUserSupport fillUserSupport) {
        return new LazyMybatisPlusMetaObjectHandler(fillUserSupport);
    }
