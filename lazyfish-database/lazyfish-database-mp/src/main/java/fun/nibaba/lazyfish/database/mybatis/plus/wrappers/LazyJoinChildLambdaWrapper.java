...
import fun.nibaba.lazyfish.database.mybatis.plus.exceptions.LazyMybatisPlusException;
import fun.nibaba.lazyfish.database.mybatis.plus.interfaces.LazyJoinCompare;
import fun.nibaba.lazyfish.database.mybatis.plus.segments.ColumnSegment;
import fun.nibaba.lazyfish.database.mybatis.plus.segments.CompareFieldSegment;
 ...
 */
public class LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass>
        extends AbstractLazyWrapper<JoinTableClass, LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass>>
        implements LazyJoinCompare<JoinTableClass, LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass>> {

    private final JoinType joinType;

    private final LazyJoinLambdaWrapper<MainTableClass> parentWrapper;

    public LazyJoinChildLambdaWrapper(JoinType joinType,
                                      LazyJoinLambdaWrapper<MainTableClass> parentWrapper,
    ...
    @Override
    public LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass> instance() {
        return new LazyJoinChildLambdaWrapper<>(this.joinType,
                this.parentWrapper,
                this.entityClass,
    ...
    public LazyJoinLambdaWrapper<MainTableClass> done() {
        return parentWrapper;
    }

    @Override
    public <RightColumnModel> LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass> joinEq(boolean condition, SFunction<JoinTableClass, ?> leftColumn, SFunction<RightColumnModel, ?> rightColumn, String tableNameAlias) {
        if (!condition) {
            return this;
        }
    ...
    @Override
    public <RightColumnModel> LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass> joinNe(boolean condition, SFunction<JoinTableClass, ?> leftColumn, SFunction<RightColumnModel, ?> rightColumn, String tableNameAlias) {
        if (!condition) {
            return this;
        }
        tableNameAlias = this.searchTableNameAlias(rightColumn, tableNameAlias);
    ...
    @Override
    public <GroupByModel> LazyJoinChildLambdaWrapper<JoinTableClass, MainTableClass> groupBy(boolean condition, SFunction<GroupByModel, ?> column) {
        throw new LazyMybatisPlusException("请使用父级sql包装器进行分组");
    }
    ...
    public String searchTableNameAlias(SFunction<?, ?> rightColumn, String tableNameAlias) {
        ...
        //验证是不是子表数据
        List<LazyJoinChildLambdaWrapper<?, MainTableClass>> joinSegmentList = this.parentWrapper.getJoinSegmentList();
        if (StrUtil.isNotBlank(tableNameAlias)) {
