...
import fun.nibaba.lazyfish.database.mybatis.plus.functions.ValueFunction;
import fun.nibaba.lazyfish.database.mybatis.plus.interfaces.*;
import fun.nibaba.lazyfish.database.mybatis.plus.model.LazyTableInfo;
import fun.nibaba.lazyfish.database.mybatis.plus.segments.*;
 ...
 */
public abstract class AbstractLazyWrapper<MainTableClass, Child extends AbstractLazyWrapper<MainTableClass, Child>>
        implements Constants,
        LazyQuery<MainTableClass, Child>,
        LazyCompare<MainTableClass, Child, Object>,
        LazyNested<Child>,
        LazyGroup<Child>,
        LazyOrder<Child> {
     ...
     * 表信息
     */
    protected final LazyTableInfo tableInfo;
    ...
    public AbstractLazyWrapper(Class<MainTableClass> mainTableClass, int tableSeq) {
        this(mainTableClass, null, tableSeq, Maps.newHashMap());
    }

    public AbstractLazyWrapper(Class<MainTableClass> mainTableClass, String tableNameAlias, int tableSeq) {
        this(mainTableClass, tableNameAlias, tableSeq, Maps.newHashMap());
    }

    public AbstractLazyWrapper(Class<MainTableClass> mainTableClass,
    ...
    public AbstractLazyWrapper(Class<MainTableClass> mainTableClass,
        ...
        this.tableInfo = LazyTableInfo.builder()
