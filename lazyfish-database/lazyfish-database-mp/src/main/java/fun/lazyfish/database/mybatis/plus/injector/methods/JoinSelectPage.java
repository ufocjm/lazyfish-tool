package fun.lazyfish.database.mybatis.plus.injector.methods;

import com.baomidou.mybatisplus.core.injector.AbstractMethod;
import com.baomidou.mybatisplus.core.metadata.TableInfo;
import com.baomidou.mybatisplus.core.toolkit.sql.SqlScriptUtils;
import fun.lazyfish.database.mybatis.plus.enums.NibabaSqlMethod;
...
public class JoinSelectPage extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        NibabaSqlMethod sqlMethod = NibabaSqlMethod.JOIN_SELECT_PAGE;
