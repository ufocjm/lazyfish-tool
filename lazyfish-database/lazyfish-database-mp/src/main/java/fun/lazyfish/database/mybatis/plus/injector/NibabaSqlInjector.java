package fun.lazyfish.database.mybatis.plus.injector;

import com.baomidou.mybatisplus.core.injector.AbstractMethod;
import com.baomidou.mybatisplus.core.injector.DefaultSqlInjector;
import fun.lazyfish.database.mybatis.plus.injector.methods.JoinSelect;
import fun.lazyfish.database.mybatis.plus.injector.methods.JoinSelectList;
import fun.lazyfish.database.mybatis.plus.injector.methods.JoinSelectPage;
import fun.lazyfish.database.mybatis.plus.mapper.NibabaMapper;
