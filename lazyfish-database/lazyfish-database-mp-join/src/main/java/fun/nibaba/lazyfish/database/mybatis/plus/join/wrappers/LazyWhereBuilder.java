...
import fun.nibaba.lazyfish.database.mybatis.plus.join.functions.ValueFunction;
import fun.nibaba.lazyfish.database.mybatis.plus.join.interfaces.LazyCompare;
import fun.nibaba.lazyfish.database.mybatis.plus.join.interfaces.LazyNested;
import fun.nibaba.lazyfish.database.mybatis.plus.join.segments.BracketSegment;
import fun.nibaba.lazyfish.database.mybatis.plus.join.segments.ColumnSegment;
import fun.nibaba.lazyfish.database.mybatis.plus.join.segments.CompareSegment;
