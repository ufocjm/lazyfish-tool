...
import fun.nibaba.lazyfish.database.mybatis.plus.join.interfaces.LazyOn;
...
import fun.nibaba.lazyfish.database.mybatis.plus.join.segments.JoinWhereSegment;
...
public class LazyJoinWrapperBuilder<Main, Join> implements
    ...
    private final JoinWhereSegment joinOnSegment;
